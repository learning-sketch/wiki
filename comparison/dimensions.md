...
| SGLang | **N/A**（命名层面无 flashcomm）— 等价思路在 [layers/communicator.py](../../sglang/python/sglang/srt/layers/communicator.py) + [layers/communicator_dsa_cp.py（原 nsa_cp，NSA→DSA 更名 #25821）](../../sglang/python/sglang/srt/layers/communicator_dsa_cp.py) | TODO |
